import 'package:app_tareas/login_fields.dart'; // Importa los campos del formulario de login
import 'package:flutter/material.dart'; // Importa el paquete de Flutter para construir la interfaz

class LoginScreen extends StatelessWidget {
  // Crea una pantalla de login que no cambia (StatelessWidget)
  const LoginScreen({
    super.key,
  }); // Constructor que permite pasar una clave única al widget
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        // Asegura que el contenido no se meta debajo de cosas como la barra de estado
        child: Center(
          ...
          child: SingleChildScrollView(
            ...
            child: ConstrainedBox(
              ...
              child:
                  LoginFields(), // Muestra los campos de texto y botones definidos en otro archivo
            ),
          ),
        ),
      ),
